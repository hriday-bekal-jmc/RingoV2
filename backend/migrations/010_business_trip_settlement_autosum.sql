...
--
-- Conditional logic (ringi):
--   accommodation fields          → has_accommodation = yes
--   has_backpay / backpay_est     → has_accommodation = yes  (packaged fare only relevant when staying)
--   has_expressway / driving_sec  → transport_mode includes car OR rental (array conditional)
--   mileage                       → has_expressway = yes
