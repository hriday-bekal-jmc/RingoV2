...
export const TEMPLATE_LABELS: Record<string, TemplateLabel> = {
  ...
  OFFICE_OVERTIME:    { ja: '早出・延長申請',     en: 'Early/Overtime Request',     desc_ja: '早出・事務所閉鎖・延長', desc_en: 'Early start / office close / overtime', icon: '🕐', gradient: 'from-amber-400/20 to-orange-500/10' },
  ...
  TARDINESS:          { ja: '遅刻・早退',         en: 'Late/Early-Leave',           desc_ja: '控除対象の勤怠申請',   desc_en: 'Attendance deduction notice',        icon: '⏰', gradient: 'from-orange-400/20 to-red-500/10' },
