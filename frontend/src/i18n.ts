...
const dict = {
  ja: {
    ...
    admin_apps_count:         '件',
    // Admin — permissions
    admin_perms_hint:         'ロールはユーザー管理タブで個別に変更できます。変更後、対象ユーザーは再ログインが必要です。',
    admin_perms_col_role:     'ロール',
    admin_perms_col_display:  '表示名 / 説明',
    admin_perms_col_submit:   '申請',
    admin_perms_col_approve:  '承認',
    admin_perms_col_settle:   '経理',
    admin_perms_col_admin:    '管理',
    admin_perm_google_title:  'Google ログイン',
    admin_perm_google_body:   '初回サインインユーザーは EMPLOYEE に自動設定されます',
    admin_perm_role_title:    'ロール変更',
    admin_perm_role_body:     '次回ログイン時に反映（JWT 再発行が必要）',
    admin_perm_route_title:   '承認ルート',
    admin_perm_route_body:    '各ステップには特定ユーザーを割り当て（管理者が設定）',
    admin_perm_admin_title:   'ADMIN 特権',
    admin_perm_admin_body:    '全ステップを代理承認できます',
  ...
  en: {
    ...
    // Admin — permissions
    admin_perms_hint:         'Roles can be changed per user in the Users tab. Users must re-login for changes to take effect.',
    ...
    admin_perm_google_body:   'First-time sign-in users are automatically assigned EMPLOYEE role',
    admin_perm_role_title:    'Role Changes',
    admin_perm_role_body:     'Takes effect on next login (JWT re-issue required)',
    admin_perm_route_title:   'Approval Routes',
    admin_perm_route_body:    'Each step is assigned a specific user (configured by admin)',
    admin_perm_admin_title:   'ADMIN Privilege',
    admin_perm_admin_body:    'Can approve any step on behalf of other users',
